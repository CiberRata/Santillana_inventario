    ...
    try {
        ...
        if ($conn) {
            ...
            $params = array(
                ...
                array(&$dias_ac_firma_entrega, SQLSRV_PARAM_OUT), // Variable de salida para almacenar el resultado
            ...
            alert("Éxito: Los datos se insertaron correctamente.");
            setTimeout(function() {
                window.location.href = "listar_insertar_equipo";
            }, 2000);
            </script>';
            exit;
        } else {
